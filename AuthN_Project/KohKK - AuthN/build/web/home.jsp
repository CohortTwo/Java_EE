...
%>
<h2>Selection :</h2>
<div>1. Department Listing</div>
<div>2. Employee Listing</div><br>

<div>
    <form id="formId" action="listing.jsp" method="GET">
        <label for="inpSelect">Selection : </label>
        <input name="inpSelect"></input>
        <button id="btnSelection">Submit</button>
</form>
</div>
