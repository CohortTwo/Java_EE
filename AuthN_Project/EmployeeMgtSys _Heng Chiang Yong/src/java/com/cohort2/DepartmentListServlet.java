 ...
 * @author chiangyong
 */
@WebServlet(name = "DepartmentListServlet", urlPatterns = {"/DepartmentListServlet"})
public class DepartmentListServlet extends HttpServlet {
    ...
    private void listDept(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
                List<Departments> deptList = deptbean.list();
                request.setAttribute("listDept", deptList);
                RequestDispatcher dispatcher = 
                        request.getRequestDispatcher("InsertNewEmployee.jsp");
